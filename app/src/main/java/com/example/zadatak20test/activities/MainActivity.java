package com.example.zadatak20test.activities;
...
import com.example.zadatak20test.adapters.DrawerAdapter;
import com.example.zadatak20test.dialog.AboutDialog;
import com.example.zadatak20test.fragments.DetailFragment;
import com.example.zadatak20test.fragments.ListAllMoviesFragment;
import com.example.zadatak20test.fragments.MasterFragment;
import com.example.zadatak20test.model.NavigationItem;
...
public class MainActivity extends AppCompatActivity implements MasterFragment.OnItemSelected, DetailFragment.OnSpinnerSelected {
   ...
   private AlertDialog aboutDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerItems.add(new NavigationItem("Show All Movies","This option shows ALL MOVIES.",R.drawable.ic_show_movies));
        drawerItems.add(new NavigationItem("About Application", "Click On me for information",R.drawable.ic_about_app));
    ...
    // ** ON ITEM CLICK MASTER FRAGMENTA.
    @Override
    public void OnItemClick(int position) {
        this.position = position;
            ...
            detailFragment.updateContent(position);
                ...
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.master_view, detailFragment, "OnClickMastera1");
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
            }
    }

    // ** ON SPINNER CLICKED DETAIL FRAGMENTA.
    @Override
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (position == 0) {
                ...
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.master_view,listAllMoviesFragment,"ListMoviesFragment");
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
            } else if (position == 1) {
                if (aboutDialog == null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                Snackbar.make(findViewById(R.id.master_view), "SUCCESFULLY DELETED", Snackbar.LENGTH_LONG).show();
                break;
    ...
    } */ // menja izgled IKONICE ZA FIOKU. pitati zasto.
